...
**Depends on:**
- [[1_0_Ehko_Manifest|Manifest]] — Core belief: Self-Forged Consciousness (§3)
- [[1_3_Security_Ownership|Security & Ownership]] — Access levels, friend registry
- [[1_4_Data_Model_v1_1|Data Model]] — prepared_messages table, conversation state schema

**Vocabulary:**
- [[4_0_Lexicon_v1_0#5.3 Relationship Types|Relationship Types]] — spouse, child, close_friend, etc.
- [[4_0_Lexicon_v1_0#5.4 Access Levels|Access Levels]] — elevated, standard, restricted
- [[4_0_Lexicon_v1_0#4.2 Emotional Tags|Emotional Tags]] — Emotion detection signals
- [[4_0_Lexicon_v1_0#5.5 Trigger Types|Trigger Types]] — Prepared message triggers

**Implemented by:**
- [[1_2_Components_v1_0|Components]] — AI Wrapper component
- [[Frontend_Implementation_Spec_v1_0|Frontend Spec]] — Chat interface

**Navigation:**
- [[_Index|← Back to Index]]
- [[1_4_Data_Model_v1_1|← Previous: Data Model]]
- [[1_6_Identity_Pillars_Scientific_Basis_v1_0|Next: Identity Pillars →]]
